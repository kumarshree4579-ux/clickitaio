...
export default function Sidebar({ onClose }: { onClose?: () => void }) {
  ...
  return (
    <aside className="w-60 h-full flex flex-col bg-[#0f172a] overflow-y-auto">

      {/* Logo + mobile close */}
      <div className="px-5 h-14 sm:h-16 flex items-center justify-between border-b border-white/[0.07] shrink-0">
