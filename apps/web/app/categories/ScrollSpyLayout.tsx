...
export default function ScrollSpyLayout({ categories }: { categories: any[] }) {
  ...
  return (
    <div className="w-full max-w-[1600px] mx-auto bg-gray-50 flex flex-row min-h-[calc(100vh-62px)] sm:min-h-[calc(100vh-65px)]">
      
      {/* Left Sidebar - Categories */}
      <aside className="w-24 sm:w-1/4 lg:w-1/5 bg-white border-r border-gray-100 shrink-0 overflow-y-auto scrollbar-hide h-[calc(100vh-62px)] sm:h-[calc(100vh-65px)] sticky top-[62px] sm:top-[65px]">
      ...
      <div 
        ref={rightPaneRef} 
        className="flex-1 w-[calc(100%-6rem)] sm:w-3/4 lg:w-4/5 overflow-y-auto h-[calc(100vh-62px)] sm:h-[calc(100vh-65px)] scroll-smooth relative"
      >
