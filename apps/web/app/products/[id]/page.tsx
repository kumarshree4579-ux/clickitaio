  ...
  return (
    <>
      ...
      <main className="bg-gray-50 min-h-screen pb-24 md:pb-8">
        ...
        {/* ── Mobile sticky CTA ── */}
        <div className="fixed bottom-[90px] left-0 right-0 z-40 md:hidden bg-white/95 backdrop-blur-sm border-t border-gray-100 px-3 py-2.5 flex items-center gap-2.5 shadow-[0_-2px_16px_rgba(0,0,0,0.08)]">
