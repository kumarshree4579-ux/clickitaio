...
export default function SupportPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-20">
      ...
      {/* Hero Banner */}
      <div className="bg-indigo-600 text-white pt-10 pb-20 px-4 rounded-b-[40px] shadow-sm relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto text-center relative z-10">
          <h1 className="text-3xl sm:text-4xl font-extrabold tracking-tight mb-4">Help & Support</h1>
          ...
          <div className="relative max-w-xl mx-auto shadow-lg shadow-indigo-900/20 rounded-2xl">
            ...
            <input 
              ...
              className="w-full pl-12 pr-4 py-4 rounded-2xl text-gray-900 focus:outline-none focus:ring-4 focus:ring-indigo-300 font-medium"
            />
          </div>
        </div>
      </div>
      ...
      <main className="max-w-4xl mx-auto px-4 -mt-8 relative z-20">
        ...
        <div className="grid grid-cols-2 gap-4 sm:gap-6 mb-12">
          <a href="mailto:support@ecomstore.com" className="bg-white p-5 sm:p-8 rounded-3xl shadow-sm border border-gray-100 hover:shadow-md hover:border-indigo-100 hover:-translate-y-1 transition-all duration-300 text-center flex flex-col items-center group">
            <div className="w-12 h-12 sm:w-16 sm:h-16 bg-indigo-50 text-indigo-600 rounded-2xl flex items-center justify-center mb-4 group-hover:bg-indigo-600 group-hover:text-white transition-colors duration-300">
            ...
            <p className="text-gray-500 text-xs sm:text-sm font-medium">support@ecomstore.com</p>
          </a>

          <a href="tel:+18001234567" className="bg-white p-5 sm:p-8 rounded-3xl shadow-sm border border-gray-100 hover:shadow-md hover:border-emerald-100 hover:-translate-y-1 transition-all duration-300 text-center flex flex-col items-center group">
            <div className="w-12 h-12 sm:w-16 sm:h-16 bg-emerald-50 text-emerald-600 rounded-2xl flex items-center justify-center mb-4 group-hover:bg-emerald-600 group-hover:text-white transition-colors duration-300">
            ...
            <p className="text-gray-500 text-xs sm:text-sm font-medium">+1 (800) 123-4567</p>
          </a>
        </div>

        {/* FAQs */}
        <div className="mb-8">
          <h2 className="text-xl font-bold text-gray-900 mb-4 px-2">Frequently Asked Questions</h2>
            ...
            {filteredFaqs.length > 0 ? filteredFaqs.map((faq, i) => (
              <div key={i} className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                <button 
                  ...
                  className="w-full px-5 py-4 sm:px-6 sm:py-5 flex items-center justify-between text-left hover:bg-gray-50 transition-colors"
                >
                  <span className={`font-semibold text-sm sm:text-base transition-colors ${openFaq === i ? 'text-indigo-600' : 'text-gray-800'}`}>
                    {faq.q}
                  </span>
                  <span className={`ml-4 flex-shrink-0 w-8 h-8 rounded-full flex items-center justify-center transition-transform duration-300 ${openFaq === i ? 'bg-indigo-100 text-indigo-600 rotate-180' : 'bg-gray-50 text-gray-400'}`}>
                ...
                <AnimatePresence>
                  {openFaq === i && (
                    ...
                    >
                      <div className="px-5 pb-5 sm:px-6 sm:pb-6 text-gray-500 text-sm leading-relaxed border-t border-gray-50 pt-4">
                        {faq.a}
                      </div>
                    </motion.div>
                  )}
